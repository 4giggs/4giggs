...
export default function CreateForm(props) {
  ...
  return (
    <>
      <Link style={{ color: 'whitesmoke' }} to='/dashboard'>
        Dashboard
      </Link>
      <Link style={{ color: 'whitesmoke' }} className='m-3' to='/addJobs'>
        Add Jobs
      </Link>

      <Container className='mt-5 p-4' style={{ border: '2px solid #06defd' }}>
        <Row>
          <Col>
